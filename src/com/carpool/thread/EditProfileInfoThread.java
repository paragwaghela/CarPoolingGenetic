...
public class EditProfileInfoThread extends Thread {
	private static String TAG="EditProfileInfoThread";
	
	public interface EditProfileInfoThreadInterface
	{
		public void onEditProfileInfoThreadDataReturned(boolean isSuccess,String msg);
		public void onEditProfileInfoThreadErrorReturned();
	}
	
	private EditProfileInfoThreadInterface mEditProfileInfoThreadInterface;
	...
	public EditProfileInfoThread(EditProfileInfoThreadInterface n, String fname, String lname, String uname,String gender,
		...
		this.mEditProfileInfoThreadInterface=n;
		this.mFName=fname;
		this.mLName=lname;
		this.mUName=uname;
		this.mGender=gender;
...
//			obj.put("profile_pic",mProfilePic);
			...
			*/obj.put("source",mSource);
			...
			final String result = HttpCalls.getPOSTResponseString(
					SharedData.SERVER_URL+"UpdateDriverServlet"+urlParams);
			JSONObject object=new JSONObject(result);
			boolean resultVal=object.getBoolean("result");
			String msg=object.getString("msg");			
			mEditProfileInfoThreadInterface.onEditProfileInfoThreadDataReturned(resultVal,msg);
		} catch (Exception e) {
			e.printStackTrace();			
			mEditProfileInfoThreadInterface.onEditProfileInfoThreadErrorReturned();
		}
	}
